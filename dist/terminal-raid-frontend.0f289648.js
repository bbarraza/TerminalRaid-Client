...
(0, _cli.createCLI)(container);

},{"./cli":"hDVRr"}],"hDVRr":[function(require,module,exports,__globalThis) {
// src/cli.ts
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createCLI", ()=>createCLI);
    ...
    async function handleCommand(input, term) {
        ...
        try {
            switch(cmd){
                case "login":
                    {
                        ...
                        const loginResp = await _api.login(username, password);
                ...
                case "logout":
                    if (currentPlayerId) {
                        await _api.logout(currentPlayerId);
                        currentPlayerId = null;
                        _api.clearAuthToken();
                        term.write("Logged out!\r\n");
                    } else term.write("Not logged in!\r\n");
                    break;
                case "start":
                    await _api.startMining();
                    term.write("Mining started!\r\n");
                    break;
                case "stop":
                    await _api.stopMining();
                    term.write("Mining stopped!\r\n");
                    break;
                case "claim":
                    await _api.claimMining();
                    term.write("Mining rewards claimed!\r\n");
                    break;
                case "status":
                    {
                        const status = await _api.miningStatus();
                ...
                case "history":
                    {
                        ...
                        const history = await _api.miningHistory(limit);
                        term.write(JSON.stringify(history, null, 2) + "\r\n");
                        break;
                    }
                case "stats":
                    {
                        const stats = await _api.miningStats();
                ...
                case "player":
                    {
                        const sub = args[1];
                        let res;
                        if (!sub) res = await _api.getPlayer();
                        else if (sub === "online") res = await _api.getOnlinePlayers();
                        else if (sub === "scan") res = await _api.scanPlayers();
                        else if (sub.startsWith("id:")) {
                            const id = sub.slice(3);
                            res = await _api.getPlayerById(id);
                        } else res = await _api.getPlayerByUsername(sub);
...
},{"xterm":"9QesI","xterm/css/xterm.css":"9ssvO","./api":"hKNQC","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9QesI":[function(require,module,exports,__globalThis) {
!function(e, t) {
    var i, s;
    module.exports = t();
}(self, ()=>(()=>{
...
},{}],"9ssvO":[function() {},{}],"hKNQC":[function(require,module,exports,__globalThis) {
// src/api.ts
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// ---------------- Auth ----------------
...
// ---------------- Mining ----------------
parcelHelpers.export(exports, "startMining", ()=>startMining);
parcelHelpers.export(exports, "stopMining", ()=>stopMining);
parcelHelpers.export(exports, "claimMining", ()=>claimMining);
parcelHelpers.export(exports, "miningStatus", ()=>miningStatus);
parcelHelpers.export(exports, "miningHistory", ()=>miningHistory);
parcelHelpers.export(exports, "miningStats", ()=>miningStats);
// ---------------- Player ----------------
parcelHelpers.export(exports, "getPlayer", ()=>getPlayer);
parcelHelpers.export(exports, "getPlayerByUsername", ()=>getPlayerByUsername);
parcelHelpers.export(exports, "getPlayerById", ()=>getPlayerById);
parcelHelpers.export(exports, "getOnlinePlayers", ()=>getOnlinePlayers);
parcelHelpers.export(exports, "scanPlayers", ()=>scanPlayers);
// ---------------- Utility ----------------
parcelHelpers.export(exports, "clearAuthToken", ()=>clearAuthToken);
let authToken = null;
...
async function claimMining() {
    return request("/Mining/claim", {
        method: "POST"
    });
}
async function miningStatus() {
    return request("/Mining/status");
}
async function miningHistory(limit = 10) {
...
},{}]},["elbaT","gNc1f"], "gNc1f", "parcelRequiree8e8", {})

//# sourceMappingURL=terminal-raid-frontend.0f289648.js.map
